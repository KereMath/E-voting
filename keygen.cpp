...
// t adet (t-1) dereceli polinom katsayısı üretir.
...
KeyGenOutput keygen(TIACParams &params, int t, int ne) {
    ...
    */
    ...
    // Polinom katsayılarını üret.
    std::vector<mpz_t> vPoly, wPoly;
    ...
    // Paralel kontrol: EA otoriteleri için hesaplamaları paralelleştiriyoruz.
    // Her EA'nın hesaplamaları birbirinden bağımsızdır.
